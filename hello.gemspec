...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Fetch current weather forecast"
  spec.description   = "Fetch current weather forecast using an API"
  spec.homepage      = "https://github.com/hansenjl/weather"
  spec.license       = "MIT"
